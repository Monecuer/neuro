import{r as l,R as W,j as N}from"./app-J0J4XT7Q.js";import{c as x}from"./clsx-B-dksMZM.js";import{_ as Te,g as re,u as ae,s as Q,a as ve,c as Pe}from"./memoTheme-BNdxtxoW.js";import{a as Ve,u as Be}from"./useTimeout-ijO9WPjY.js";import{b as Se,_ as we,T as oe,a as H}from"./TransitionGroupContext-CUmnvxwJ.js";import{k as Z}from"./emotion-react.browser.esm-BQ7e9N_g.js";import{u as ie}from"./useForkRef-npmdbavI.js";function se(e){try{return e.matches(":focus-visible")}catch{}return!1}class G{static create(){return new G}static use(){const t=Ve(G.create).current,[o,a]=l.useState(!1);return t.shouldMount=o,t.setShouldMount=a,l.useEffect(t.mountEffect,[o]),t}constructor(){this.ref={current:null},this.mounted=null,this.didMount=!1,this.shouldMount=!1,this.setShouldMount=null}mount(){return this.mounted||(this.mounted=Le(),this.shouldMount=!0,this.setShouldMount(this.shouldMount)),this.mounted}mountEffect=()=>{this.shouldMount&&!this.didMount&&this.ref.current!==null&&(this.didMount=!0,this.mounted.resolve())};start(...t){this.mount().then(()=>this.ref.current?.start(...t))}stop(...t){this.mount().then(()=>this.ref.current?.stop(...t))}pulsate(...t){this.mount().then(()=>this.ref.current?.pulsate(...t))}}function De(){return G.use()}function Le(){let e,t;const o=new Promise((a,n)=>{e=a,t=n});return o.resolve=e,o.reject=t,o}function je(e){if(e===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function ee(e,t){var o=function(i){return t&&l.isValidElement(i)?t(i):i},a=Object.create(null);return e&&l.Children.map(e,function(n){return n}).forEach(function(n){a[n.key]=o(n)}),a}function ke(e,t){e=e||{},t=t||{};function o(d){return d in t?t[d]:e[d]}var a=Object.create(null),n=[];for(var i in e)i in t?n.length&&(a[i]=n,n=[]):n.push(i);var s,c={};for(var u in t){if(a[u])for(s=0;s<a[u].length;s++){var p=a[u][s];c[a[u][s]]=o(p)}c[u]=o(u)}for(s=0;s<n.length;s++)c[n[s]]=o(n[s]);return c}function k(e,t,o){return o[t]!=null?o[t]:e.props[t]}function Ne(e,t){return ee(e.children,function(o){return l.cloneElement(o,{onExited:t.bind(null,o),in:!0,appear:k(o,"appear",e),enter:k(o,"enter",e),exit:k(o,"exit",e)})})}function $e(e,t,o){var a=ee(e.children),n=ke(t,a);return Object.keys(n).forEach(function(i){var s=n[i];if(l.isValidElement(s)){var c=i in t,u=i in a,p=t[i],d=l.isValidElement(p)&&!p.props.in;u&&(!c||d)?n[i]=l.cloneElement(s,{onExited:o.bind(null,s),in:!0,exit:k(s,"exit",e),enter:k(s,"enter",e)}):!u&&c&&!d?n[i]=l.cloneElement(s,{in:!1}):u&&c&&l.isValidElement(p)&&(n[i]=l.cloneElement(s,{onExited:o.bind(null,s),in:p.props.in,exit:k(s,"exit",e),enter:k(s,"enter",e)}))}}),n}var Fe=Object.values||function(e){return Object.keys(e).map(function(t){return e[t]})},Ie={component:"div",childFactory:function(t){return t}},te=function(e){Se(t,e);function t(a,n){var i;i=e.call(this,a,n)||this;var s=i.handleExited.bind(je(i));return i.state={contextValue:{isMounting:!0},handleExited:s,firstRender:!0},i}var o=t.prototype;return o.componentDidMount=function(){this.mounted=!0,this.setState({contextValue:{isMounting:!1}})},o.componentWillUnmount=function(){this.mounted=!1},t.getDerivedStateFromProps=function(n,i){var s=i.children,c=i.handleExited,u=i.firstRender;return{children:u?Ne(n,c):$e(n,s,c),firstRender:!1}},o.handleExited=function(n,i){var s=ee(this.props.children);n.key in s||(n.props.onExited&&n.props.onExited(i),this.mounted&&this.setState(function(c){var u=Te({},c.children);return delete u[n.key],{children:u}}))},o.render=function(){var n=this.props,i=n.component,s=n.childFactory,c=we(n,["component","childFactory"]),u=this.state.contextValue,p=Fe(this.state.children).map(s);return delete c.appear,delete c.enter,delete c.exit,i===null?W.createElement(oe.Provider,{value:u},p):W.createElement(oe.Provider,{value:u},W.createElement(i,c,p))},t}(W.Component);te.propTypes={};te.defaultProps=Ie;function Ue(e){const{className:t,classes:o,pulsate:a=!1,rippleX:n,rippleY:i,rippleSize:s,in:c,onExited:u,timeout:p}=e,[d,h]=l.useState(!1),M=x(t,o.ripple,o.rippleVisible,a&&o.ripplePulsate),P={width:s,height:s,top:-(s/2)+i,left:-(s/2)+n},b=x(o.child,d&&o.childLeaving,a&&o.childPulsate);return!c&&!d&&h(!0),l.useEffect(()=>{if(!c&&u!=null){const w=setTimeout(u,p);return()=>{clearTimeout(w)}}},[u,c,p]),N.jsx("span",{className:M,style:P,children:N.jsx("span",{className:b})})}const g=re("MuiTouchRipple",["root","ripple","rippleVisible","ripplePulsate","child","childLeaving","childPulsate"]),J=550,ze=80,Oe=Z`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
